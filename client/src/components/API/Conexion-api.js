...
export const getProducts = () =>
  axios.get("https://quillas-bakery-cristhianac-5656dd75.koyeb.app/api/producto/");

export const getClienteGoogle = (email, nombre) =>
  axios.post("https://quillas-bakery-cristhianac-5656dd75.koyeb.app/api/cliente/google_login/", {
    correo: email,
    nombre: nombre,
  });
...
export const validateClient = (email, password) =>
  axios.get(`https://quillas-bakery-cristhianac-5656dd75.koyeb.app/api/cliente/check_password/?email=${email}&password=${password}`);

export const agregarItem = (correo, idItem, cantidad) =>
  axios.post("https://quillas-bakery-cristhianac-5656dd75.koyeb.app/api/carritoproducto/add_item/", {
    correo: correo,
    producto_id: idItem,
    cantidad: cantidad,
  });
